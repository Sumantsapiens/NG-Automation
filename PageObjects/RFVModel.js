function RFVModel() {
    ...
    this.RFVname=element(by.linkText('Decin1 (View: 111) [V0]'));
    ...
    this.Messagedescription=element.all(by.xpath('//*[@class="sidebar-container__validation-message__description"]'));
